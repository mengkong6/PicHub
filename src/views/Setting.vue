...
const cdns = ref([{'name':'https://cdn.jsdelivr.net','id':0},{'name':'https://gcore.jsdelivr.net','id':1},{'name':'https://fastly.jsdelivr.net','id':2},{'name':'https://originfastly.jsdelivr.net','id':3},{'name':'https://quantil.jsdelivr.net','id':4}] as any)
...
<template>
  <div class="form">
    ...
    <div class="form">
      ...
      <lew-form-item v-show="repos.length > 0" title="请选择一个CDN">
        <lew-select
          v-model="user.cdn"
          :option="cdns"
          label="name"
